...
build d  
   ...
   | (9 < ra) && (ra < 12) = Times (Sine(build(d-1))) (Cosine (build(d-1)))
   | (12 < ra) && (ra < 14) = Thresh (build(d-1)) (build(d-1)) (Cosine(Sine (build(d-1)))) (Sine (build(d-1)))
   | otherwise                = Times (Sine (build((d-1)))) (build(d-1))
  where
    ra = rand 16 --generating a random num from 0 to 16
...
-- grayscale
g1, g2, g3 :: (Int, Int)
g1 = (8, 324)  -- Reduced from 9
g2 = (10, 9742)  -- Reduced from 15
g3 = (12, 2)    -- Reduced from 18


-- grayscale
c1, c2, c3 :: (Int, Int)
c1 = (8, 90)   -- Reduced from 10
c2 = (8, 1337)  -- Reduced from 10
c3 = (10, 1337)  -- Reduced from 12
